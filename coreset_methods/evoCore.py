...
from visualizer import plot_fitness_scatter
...
class EvoCore(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None, **fit_params):
        ...
        self.x_train_, x_val = X[train_index], X[val_index]
    ...
    def transform(self, X, **fit_params):
        return self.x_core_, self.y_core_, list(self.core_set_)
    ...
    def _variate(self, random, candidates, args):
        ...
        for parent1, parent2 in zip(fathers, mothers):
            ...
            for child in children:
                ...
                while True: # infinite loop here if len(child) == self.x_train_.shape(), then new_val is always in child causing the condition to be always true
    ...
    def _observe_core_sets(self, population, num_generations, num_evaluations, args):
        # fitness_list = [[ind.fitness[1], ind.fitness[0]] for ind in population]
        # plot_fitness_scatter(fitness_list, num_generations, "EvoCore")
